...
<div class="container-fluid py-4">
    <div class="row">
        <div class="card mb4">
            ...
            <form action="{{url("/store/add-store")}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" value="{{ old('name') }}"  name="name" placeholder="{{__('Enter_store_name')}}">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" value="{{ old('adresse') }}" name="adresse" placeholder="{{__('Enter_store_adresse')}}">
